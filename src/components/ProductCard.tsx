  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-4">
        ...
        {/* Name */}
        <h3 className="font-semibold text-sm sm:text-base text-gray-900 mt-1 line-clamp-2 min-h-[2.5em]">
          {product.name}
        </h3>
        ...
        <div className="mt-2 flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="bg-pink-600 hover:bg-pink-700 text-white p-2 rounded-lg transition-colors active:scale-95 shrink-0"
          >
